...
{
    public class a_type_finder_that_finds_two_resource_representations_providing_implementation_for_the_same_service : all_dependencies
    {
        ...
        Establish context = () =>
        {
            var resource_type_representation_types = new List<Type>
            {
                ...
                typeof(resource_type_with_first_service_for_third_resource_type_and_first_implementation)
            };
