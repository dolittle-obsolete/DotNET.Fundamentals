...
{
    public class when_trying_to_read_file_with_path_up_a_level_in_the_hwhen_trying_to_write_file_with_path_up_a_level_in_the_hierarchy_unixierarchy_unix : given.a_tenant_aware_file_system
    {
