...
{
    public class when_asking_if_can_provide_for_configuration_object_type_not_used_by_performer : given.all_dependencies
    {
        ...
        It should_not_be_able_to_provide = () => result.ShouldBeFalse();
    }
}