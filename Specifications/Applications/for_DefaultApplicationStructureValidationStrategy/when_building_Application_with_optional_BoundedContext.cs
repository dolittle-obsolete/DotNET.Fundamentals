...
{
    public class when_building_Application_with_optional_BoundedContext : given.a_standard_ApplicationBuilder
    {
        ...
        It should_have_an_inner_exception_of_ApplicationStructureMustStartWithABoundedContext = () => result.InnerException.ShouldBeOfExactType(typeof(RequiredStructureFragmentMustBeSetAsRequired));
