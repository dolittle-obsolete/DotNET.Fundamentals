...
{
    public class when_resolving_type_callback_binding : given.no_instances
    {
        ...
        Establish context = () =>
        {
            ...
            binding = new Binding(service_type, new Strategies.TypeCallback(() => binding_type), new Scopes.SingletonPerTenant());
