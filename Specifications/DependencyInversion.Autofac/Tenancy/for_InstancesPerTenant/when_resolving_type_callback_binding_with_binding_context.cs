...
{
    public class when_resolving_type_callback_binding_with_binding_context : given.no_instances
    {
        ...
        Establish context = () =>
        {
            ...
            binding = new Binding(service_type, new Strategies.TypeCallbackWithBindingContext((c) => {
                binding_context = c;
                return binding_type;
