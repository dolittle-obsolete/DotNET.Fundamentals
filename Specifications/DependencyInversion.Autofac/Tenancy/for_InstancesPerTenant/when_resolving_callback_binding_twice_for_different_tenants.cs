...
{
    public class when_resolving_callback_binding_twice_for_different_tenants : given.no_instances
    {
        ...
        Establish context = () =>
        {
            binding = new Binding(typeof(string), new Strategies.Callback(() => new object()), new Scopes.SingletonPerTenant());
