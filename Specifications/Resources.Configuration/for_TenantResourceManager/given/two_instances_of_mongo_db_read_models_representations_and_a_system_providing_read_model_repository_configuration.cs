...
{
    public class two_instances_of_mongo_db_read_models_representations_and_a_system_providing_read_model_repository_configuration : all_dependencies
    {
        ...
        Establish context = () => 
        {
            var first_read_models_representation = new ResourceRepresentationForMongoDbReadModels();
            var second_read_models_representation = new ResourceRepresentationForMongoDbReadModels();
