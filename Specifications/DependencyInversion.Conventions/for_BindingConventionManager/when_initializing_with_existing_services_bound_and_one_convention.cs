...
namespace doLittle.DependencyInversion.Conventions.Specs.for_BindingConventionManager
{
    public class when_initializing_with_existing_services_bound_and_one_convention : given.a_binding_convention_manager_with_one_type
    {
        ...
        Establish context = () =>
                                {
                                    ...
                                    container.Setup(c => c.GetBoundServices()).Returns(new[] {service_type});
        ...
        It should_not_ask_to_resolve = () => convention_mock.Verify(c => c.CanResolve(container.Object, service_type), Times.Never());
    }
}