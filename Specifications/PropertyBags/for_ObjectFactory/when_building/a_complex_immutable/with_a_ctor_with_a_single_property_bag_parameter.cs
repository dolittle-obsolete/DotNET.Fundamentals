namespace Dolittle.PropertyBags.Specs.for_ObjectFactory.when_building.a_complex_immutable
{
    ...
    public class with_a_ctor_with_a_single_property_bag_parameter : given.an_object_factory
    {
        ...
        {
            factory = instance;
            immutable_type = new ComplexImmutableWithMultipleParameterConstructor(42,"Forty-Two",DateTime.UtcNow, new ImmutableWithMultipleParameterConstructor(43,"Forty-Three",DateTime.UtcNow.AddDays(1)));
