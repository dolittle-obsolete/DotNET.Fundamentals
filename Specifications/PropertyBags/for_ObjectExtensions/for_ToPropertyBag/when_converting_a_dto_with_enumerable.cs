...
namespace Dolittle.PropertyBags.Specs.for_ObjectExtensions.for_ToPropertyBag
{
    public class when_converting_a_dto_with_enumerable
    {
        ...
        Establish context = () => dto_with_enumerable_of_string = new DtoWithEnumerableSimple() { StringList = new List<string> { "element1", "element2" } };

        Because of = () => dto_with_enumerable_of_string_result = dto_with_enumerable_of_string.ToPropertyBag();

        It dto_with_enumerable_of_string_result_should_not_be_null = () => dto_with_enumerable_of_string_result.ShouldNotBeNull();
        It should_have_key = () => dto_with_enumerable_of_string_result.ContainsKey(nameof(dto_with_enumerable_of_string.StringList)).ShouldBeTrue();
