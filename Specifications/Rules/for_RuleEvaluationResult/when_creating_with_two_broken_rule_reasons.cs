...
{
    public class when_creating_with_two_broken_rule_reasons
    {
        ...
        Because of = () => result = new RuleEvaluationResult(instance, first_reason_instance, second_reason_instance);
