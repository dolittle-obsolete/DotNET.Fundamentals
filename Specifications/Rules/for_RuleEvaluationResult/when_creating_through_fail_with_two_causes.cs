...
namespace Dolittle.Rules.for_RuleEvaluationResult
{
    public class when_creating_through_fail_with_two_causes
    {
        ...
        Because of = () => result = RuleEvaluationResult.Fail(instance, first_cause, second_cause);
        ...
        It should_hold_both_reasons = () => result.Causes.ShouldContainOnly(first_cause, second_cause);
    }
}